  ...
  return (
    <div className="space-y-8 pb-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center space-x-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl">
              ...
              <label className="text-xs text-slate-300 font-semibold">Statement Period:</label>
              <select
                value={selectedPeriod}
                onChange={(e) => setSelectedPeriod(e.target.value)}
                className="bg-slate-900 text-slate-100 text-xs font-bold py-1 px-3 rounded-lg border border-indigo-500/30 focus:outline-hidden focus:border-indigo-400"
              >
      ...
      <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/15 shadow-xl shadow-black/10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center space-x-1.5 text-xs text-indigo-300 hover:text-indigo-200 bg-indigo-500/20 hover:bg-indigo-500/30 border border-indigo-500/30 px-3 py-1.5 rounded-xl transition-all shadow-sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 mb-4 p-3.5 rounded-xl bg-slate-950/40 border border-white/10 text-xs">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <span
                className={`font-mono text-[11px] font-bold px-2 py-0.5 rounded border transition-colors ${
                  isYearValid
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <label htmlFor="upload-statement-month" className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block mb-1">
                  Month
                </label>
                <select
                  ...
                  className="w-full px-2.5 py-1.5 rounded-lg border border-white/15 bg-slate-900 text-slate-200 text-xs font-semibold focus:outline-hidden focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400"
                >
              ...
              <div>
                <label htmlFor="upload-statement-year" className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block mb-1">
                  Year (2026–2036)
                </label>
                <input
                  ...
                  placeholder="2026"
                  className={`w-full px-2.5 py-1.5 rounded-lg border bg-slate-900 font-mono text-xs font-semibold focus:outline-hidden transition-all ${
                    !isYearValid
            ...
            {!isYearValid && (
              <div className="flex items-center space-x-1 text-rose-400 text-[11px] font-medium pt-0.5 animate-fadeIn">
          ...
          <div>
            <label htmlFor="upload-default-cardholder" className="text-slate-200 font-semibold block mb-1">
              Cardholder:
            </label>
            <select
              ...
              className="w-full px-2.5 py-1.5 rounded-lg border border-white/15 bg-slate-900 text-slate-200 text-xs font-semibold focus:outline-hidden focus:border-indigo-400"
            >
          ...
          <div className="flex flex-col justify-between">
            <div>
              <span className="text-slate-300 font-semibold block mb-1">Smart Columns Accepted:</span>
            ...
            <button
              ...
              className="mt-2 text-[11px] font-semibold text-emerald-300 hover:text-emerald-200 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 px-2.5 py-1 rounded-lg transition-colors text-left flex items-center gap-1"
            >
        ...
        >
          <div className="max-w-xl mx-auto space-y-2.5">
            <textarea
              ...
              className="w-full text-xs font-mono px-3 py-2 rounded-xl border border-white/15 bg-slate-950/80 text-slate-200 placeholder-slate-500 focus:border-indigo-400 focus:outline-hidden"
            />
            ...
            {rawText.trim() && (
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="px-3 py-1 text-slate-400 hover:text-slate-200 text-xs transition-colors"
                >
                  Clear Input
                </button>
                <button
                  ...
                  className={`px-4 py-1.5 rounded-xl font-semibold text-xs transition-all shadow-md ${
                    !isYearValid
        ...
        {parsedItems.length > 0 && (
          <div className="mt-6 pt-6 border-t border-white/10 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-indigo-950/40 border border-indigo-500/30 p-3.5 rounded-xl">
              <div className="flex items-center space-x-2.5">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="text-xs text-slate-400 hover:text-rose-400 px-2.5 py-1.5 transition-colors"
                >
                  Discard
                </button>
                <button
                  ...
                  className={`flex items-center space-x-1.5 text-xs font-bold px-4 py-2 rounded-xl transition-all shadow-lg ${
                    !isYearValid
            ...
            <div className="overflow-x-auto rounded-xl border border-white/10 max-h-96">
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-900/90 sticky top-0 text-slate-400 uppercase tracking-wider font-semibold border-b border-white/10 text-[11px] z-10">
                  <tr>
                ...
                <tbody className="divide-y divide-white/5 bg-slate-950/40">
                  {parsedItems.map((tx) => (
                    <tr key={tx.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="py-2.5 px-3 font-medium text-slate-100">{tx.merchant}</td>
                      <td className="py-2.5 px-3 font-mono font-bold text-emerald-300">
                        <input
                          ...
                          className="w-24 px-2 py-0.5 rounded bg-slate-900 border border-white/15 text-white font-mono text-xs focus:outline-hidden focus:border-indigo-400"
                        />
                      </td>
                      <td className="py-2.5 px-3">
                        <select
                          ...
                          className="text-xs px-2 py-1 rounded-lg border border-white/15 bg-slate-900 text-slate-200 font-medium focus:outline-hidden"
                        >
                      ...
                      <td className="py-2.5 px-3">
                        <select
                          ...
                          className="text-xs px-2 py-0.5 rounded bg-slate-900 border border-white/15 text-slate-200 font-medium focus:outline-hidden"
                        >
                          <option value="bunny">🐰 Bunny</option>
                          <option value="monkey">🐵 Monkey</option>
                        </select>
          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-white/5 text-slate-400 uppercase tracking-wider font-semibold border-b border-white/10 text-[11px]">
              <tr>
                ...
                <th className="py-3 px-3">Statement Period</th>
                    ...
                    <tr key={tx.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="py-3 px-3">
                        <select
                          ...
                          className="font-mono text-[11px] text-indigo-300 bg-slate-900 px-2 py-0.5 rounded-md border border-indigo-500/20 focus:outline-hidden"
                        >
                          {availablePeriods.map((p) => (
                            <option key={p.id} value={p.id}>
                              {p.label}
                        ...
                        {isEditingAmt ? (
                          <div className="flex items-center justify-end space-x-1">
                            <input
                              ...
                              className="w-20 px-1.5 py-0.5 bg-slate-900 border border-indigo-400 rounded text-right text-xs text-white"
                              autoFocus
                              onKeyDown={(e) => {
